-- proc_load_silver_pgsql.sql
/*
===============================================================================
Stored Procedure: Load Silver Layer (Bronze -> Silver) - PostgreSQL Version
===============================================================================
Script Purpose:
...
BEGIN
    BEGIN
        ...
        SELECT
            CASE
                WHEN cid LIKE 'NAS%' THEN SUBSTRING(cid FROM 4) -- Remove 'NAS' prefix if present
                ELSE cid
            END AS cid, 
            CASE
